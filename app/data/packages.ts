...
const HOMEBREW_CASK_90D_API_URL =
  "https://formulae.brew.sh/api/analytics/cask-install/90d.json";
const HOMEBREW_CASK_365D_API_URL =
...
export async function fetchMostUsedPackages(): Promise<BrewPackage[]> {
  try {
    ...
    const [analytics365Response, analytics90Response, caskDetailsResponse] =
      await Promise.all([
...
function guessCategory(description: string): BrewPackage["category"] {
  ...
  if (
    lowerDesc.includes("video conference") ||
...
export const staticBrewPackages: BrewPackage[] = [
  {
    ...
    popular: true,
    iconUrl:
      "https://www.google.com/s2/favicons?domain=https://code.visualstudio.com&sz=128",
  },
  {
    id: "iterm2",
    name: "iterm2",
